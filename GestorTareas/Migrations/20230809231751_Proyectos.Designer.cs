...
namespace GestorTareas.Migrations
{
    ...
    [Migration("20230809231751_Proyectos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SubTareasTareas", b =>
                {
                    ...
                    b.HasKey("SubTareaId", "TareaId");

                    b.HasIndex("TareaId");

                    b.ToTable("SubTareasTareas");
                });
            ...
            modelBuilder.Entity("SubTareasTareas", b =>
                {
                    b.HasOne("GestorTareas.Models.SubTareas", null)
                        .WithMany()
                        .HasForeignKey("SubTareaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestorTareas.Models.Tareas", null)
                        .WithMany()
